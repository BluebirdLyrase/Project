...
public class HistorySearchTextView extends ViewPart {
	 ...
	 */
	public static final String ID = "stackoverflow.ViewAndDialog.HistoryView";
...
//        TableColumn lastNameCol = new TableColumn(viewer);
//        TableColumn emailCol = new TableColumn(viewer);

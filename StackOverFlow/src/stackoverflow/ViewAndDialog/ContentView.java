	...
	private Device device ;
	 @Override
	    public void createPartControl(Composite parent) {
	        ...
	        Text viewer = new Text(parent, SWT.BORDER);
	        viewer.setText("Imagine a fantastic user interface here");
	        Label label = new Label(parent, SWT.NONE);
	        Color color = new Color(device, SWT.COLOR_RED,SWT.COLOR_GREEN,SWT.COLOR_BLUE);
	        label.setText("This is a Gorgeous label");
	        
	        StyledText sText = new StyledText(parent, SWT.NONE);
	        color.getBlue();
	        sText.setBackground(color);
	        sText.setText(label.getText());
	    }
